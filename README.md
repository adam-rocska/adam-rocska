...
| Project                                                                             | Description                                                                                                        |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [**`@adam-rocska/VersionInfo`**](https://github.com/adam-rocska/VersionInfo.swift)  | Build-time Git and SemVer metadata for Swift targets, compiled in as plain Swift with zero runtime Git dependency. |
